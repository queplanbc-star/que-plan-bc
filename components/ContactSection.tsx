...
export const ContactSection: React.FC<{ id?: string }> = ({ id }) => {
  return (
    <section id={id} className="py-6 md:py-12 px-3 md:px-0 bg-white rounded-2xl shadow-none md:shadow-sm border border-gray-100 mb-12 animate-fade-in">
      <div className="max-w-3xl mx-auto px-0 md:px-6">
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-6">
            ...
            <div className="space-y-1 md:space-y-2">
              <label htmlFor="dateTime" className="block text-xs md:text-sm font-medium text-gray-700">
                Fecha y Hora
              </label>
              <input
                type="text"
          ...
          <div className="pt-2 md:pt-4">
            <button
              type="submit"
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2.5 md:py-4 px-4 md:px-8 rounded-lg md:rounded-xl shadow-md md:shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 text-sm md:text-lg"
            >
